              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../../../action.php" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="jenis" class="form-control" id="exampleSelectGender">
                          <?php 
                            while ($isi = mysqli_fetch_object($categori)) {
                                ?>
                          <optio value="<?= $isi->id_categori;?>"><?= $isi->nm_categori; ?></optio>
                        ...
                        <select name="produk" class="form-control" id="exampleSelectGender">
                          <?php 
                            while ($tampil = mysqli_fetch_object($jenis)) {
                                ?>
                          <optio value="<?= $tampil->id_jenisproduk;?>"><?= $tampil->nm_jenisproduk; ?></optio>
